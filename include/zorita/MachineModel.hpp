...
/// @brief Number of data registers (R0 to R15).
constexpr uint8_t num_data_registers = 16;
...
constexpr uint8_t cmp_op1_opcode_begin = 9;
constexpr uint8_t cmp_op2_opcode_begin = 5;
constexpr uint8_t jmp_cond_opcode_begin = 9;
constexpr uint8_t jmp_addr_opcode_begin = 5;
constexpr uint8_t load_reg_opcode_begin = 9;
constexpr uint8_t load_addr_opcode_begin = 5;
constexpr uint8_t store_reg_opcode_begin = 9;
constexpr uint8_t store_addr_opcode_begin = 5;
constexpr uint8_t add_dst_opcode_begin = 9;
constexpr uint8_t add_src1_opcode_begin = 5;
constexpr uint8_t add_src2_opcode_begin = 1;
constexpr uint8_t sub_dst_opcode_begin = 9;
constexpr uint8_t sub_src1_opcode_begin = 5;
constexpr uint8_t sub_src2_opcode_begin = 1;
constexpr uint8_t register_opcode_mask = 0b1111;
